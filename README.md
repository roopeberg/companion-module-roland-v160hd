...
The V-160HD has two rows of 10 buttons on the hardware panel, giving 20 logical INPUT/XPT slots. Companion exposes all 20 for PGM, PVW, AUX, PiP, and DSK source selection. Which physical inputs are routed to which slots depends on the **Panel Operation mode** set on the switcher itself:
