module.exports = {
	TALLYDATA: [
		...
		{ id: 32, label: 'INPUT 1', shortlabel: 'input1', status: 0 },
		{ id: 33, label: 'INPUT 2', shortlabel: 'input2', status: 0 },
		{ id: 34, label: 'INPUT 3', shortlabel: 'input3', status: 0 },
		{ id: 35, label: 'INPUT 4', shortlabel: 'input4', status: 0 },
		{ id: 36, label: 'INPUT 5', shortlabel: 'input5', status: 0 },
		{ id: 37, label: 'INPUT 6', shortlabel: 'input6', status: 0 },
		{ id: 38, label: 'INPUT 7', shortlabel: 'input7', status: 0 },
	...
	CHOICES_INPUTSASSIGN: [
		...
		{ id: 32, label: 'N/A' }, // 0x20 = unassigned/N/A in Input Assign context
	],

	// Sources available for DSK Key/Fill — superset of CHOICES_INPUTSASSIGN that also
	// includes INPUT/XPT 1–20 (0x20–0x33). Integer ids map directly to the protocol byte.
	CHOICES_DSK_SOURCES: [
		{ id: 0, label: 'HDMI 1' },
		{ id: 1, label: 'HDMI 2' },
		{ id: 2, label: 'HDMI 3' },
		...
		{ id: 30, label: 'Still 15' },
		{ id: 31, label: 'Still 16' },
		{ id: 32, label: 'INPUT/XPT 1' }, // 0x20
		{ id: 33, label: 'INPUT/XPT 2' },
		{ id: 34, label: 'INPUT/XPT 3' },
		{ id: 35, label: 'INPUT/XPT 4' },
		{ id: 36, label: 'INPUT/XPT 5' },
		{ id: 37, label: 'INPUT/XPT 6' },
		{ id: 38, label: 'INPUT/XPT 7' },
		{ id: 39, label: 'INPUT/XPT 8' },
		{ id: 40, label: 'INPUT/XPT 9' },
		{ id: 41, label: 'INPUT/XPT 10' },
		{ id: 42, label: 'INPUT/XPT 11' },
		{ id: 43, label: 'INPUT/XPT 12' },
		{ id: 44, label: 'INPUT/XPT 13' },
		{ id: 45, label: 'INPUT/XPT 14' },
		{ id: 46, label: 'INPUT/XPT 15' },
		{ id: 47, label: 'INPUT/XPT 16' },
		{ id: 48, label: 'INPUT/XPT 17' },
		{ id: 49, label: 'INPUT/XPT 18' },
		{ id: 50, label: 'INPUT/XPT 19' },
		{ id: 51, label: 'INPUT/XPT 20' }, // 0x33
	],
